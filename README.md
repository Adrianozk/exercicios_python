...
- entrada, saída e tipos primitivos;
...
```text
.
├── enunciados/   # imagens dos exercícios e materiais de apoio
└── resolucoes/   # soluções em Python, organizadas por número
```

## Como executar

É necessário ter o Python instalado. Na raiz do repositório, execute uma solução pelo número:

```bash
python resolucoes/ex050.py
```

Em sistemas nos quais o executável é chamado `python3`:

```bash
python3 resolucoes/ex050.py
```

A maioria dos exercícios é interativa e solicitará valores pelo terminal.
